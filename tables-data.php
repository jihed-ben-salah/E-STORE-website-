...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Data Table : avis</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
			...
			?>
				<tr>
					<td><?PHP echo $avis['idP']; ?></td>
					<td><?PHP echo $avis['etoile']; ?></td>
					...
					<td>
				<a href="../views/modifier_avis.php?id=<?PHP echo $avis['id']; ?>">Modifier</a>
