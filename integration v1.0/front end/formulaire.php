          ...
          <ol class="one-page-checkout" id="checkoutSteps">
            ...
            <li id="opc-billing" class="section allow active">
              <div class="step-title"> <span class="number">1</span>
                <h3 class="one_page_heading">Chére Client Confirmer Votre Vommande</h3>
                <!--<a href="#">Edit</a>--> 
              </div>
                            ...
                            <li>
                              <div class="customer-name">
                                <div class="input-box name-firstname">
                                 <div><label>Votre ville<span class="required">*</span></label></div>
      <div><input type="text" id="ville" name="ville" placeholder="Ariana"class="input-text required-entry" required> <span id='ville'></span><br></div>
	     <span id='missville'></span><br>
                                </div>
								
                              <div class="input-box name-firstname">
                                 <div><label>Votre Rue<span class="required">*</span></label></div>
      <div><input type="text" id="rue" name="rue" placeholder="Rue ibn mandhour "class="input-text required-entry" required> <span id='ville'></span><br></div>
	     <span id='missrue'></span><br>
                            ...
                            <li>
                                 <div class="input-box name-firstname">
                                 <div><label>Adresse e-mail<span class="required">*</span></label></div>
          <div><input type="email" id="email_addr" name="email_addr" placeholder="houda.koubaa@esprit.tn "class="input-text required-entry" required> <span id='ville'></span><br></div>
	     <span id='missadr'></span><br>
                                </div>
                              <div class="input-box name-firstname">
                                 <div><label>Confirmez l'adresse e-mail<span class="required">*</span></label></div>
          <div><input type="email" id="email_addr_repeat" name="email_addr_repeat" placeholder="houda.koubaa@esprit.tn "class="input-text required-entry" required> <span id='ville'></span><br></div>
	     <span id='missadrr'></span><br>
                            ...
                            <li>
                              ...
                              <div class="input-box">
                                ...
                                <br />
                                <input type="number" name="tel" title="tel" class="input-text" id="tel" placeholder="98 888 888" />
                    ...
                    <p class="require"><em class="required">* </em>Champs vides</p>
                    <button type="submit" value="envoyer" id='bouton_envoi' class="button continue" ><span>Confirmer</span></button>
                  </fieldset>
                </form>
              </div>
            </li>
...
var i;
  ...
  var formValid = document.getElementById('bouton_envoi');
			...
			var tel= document.getElementById('billing:telephone');
