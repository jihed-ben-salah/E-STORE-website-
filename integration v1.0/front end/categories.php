        ...
        <div class="container">
          ...
          <div class="top-search">
            <div class="block-icon pull-right"> <a data-target=".bs-example-modal-lg" data-toggle="modal" class="search-focus dropdown-toggle links"> <i class="fa fa-search"></i> </a>
              ...
              <div class="toplinks">
                <div class="links">
                 <div class="demo"><a title="Blog" href="comptefournisseur.php"><span class="hidden-xs">Fournisseur</span></a></div>
                  ...
                  <div class="login"><a href="formconnexionuser.php"><span class="hidden-xs">Connexion</span></a></div>
                  <?php }else{ ?>
                    <div class="login"><a href="formconnexionuser.php"><span class="hidden-xs">bienvenue <?php echo $_SESSION['nom'];?></span></a></div>
                    <div class="login"><a href="deconnexionuser.php"><span class="hidden-xs">Deconnexion</span></a></div>
                    <?php } ?>
                </div>
 ...
 <!-- Slider
  ...
  <section class="featured-pro container wow bounceInUp animated">
    <div class="slider-items-products container">
      ...
      <div id="featured-slider" class="product-flexslider hidden-buttons">
        <div class="slider-items slider-width-col4 products-grid">
           <?php require_once 'listefront.php'; ?> 
        </div>
      </div>
    </div>
  </section>
