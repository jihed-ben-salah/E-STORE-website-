            ...
            <form method="post" action="afficherProduit.php">
              <fieldset>
                <table class="data-table cart-table" id="shopping-cart-table">
                  ...
                  <tfoot>
                    <tr class="first last">
                      <td class="a-right last" colspan="50"><button onclick='' class="button btn-continue" title="Continue Shopping" type="button" href="categories.php"><span>Continue Shopping</span></button>
                        <button class="button btn-update" title="Update" value="Qty" name="update_cart_action" type="submit"><span>Update Cart</span></button>
                  ...
                  $produitss = array();
                    ...
                    $produits = $DB->query('SELECT * FROM produit WHERE idP IN('. implode(',',$ids).')');
                  ...
                  foreach($produitss as $produitt):?>
                      ...
                      <td class="image"><a class="product-image" title="" href="#"><img width="75" height="75" src="../views/assets/images/<?PHP echo $produitt['imageP']; ?>"></a></td>
                      <td><h2 class="product-name"> <a href="#"><?PHP echo $produitt['nomP']; ?></a> </h2></td>
                      <td class="a-center hidden-table"><a title="Edit item parameters" class="edit-bnt" href="#"></a></td>
                      <td class="a-center hidden-table"><span class="cart-price"> <span class="price"></span> <?= number_format ($produitt['tarifRP'],2,',',' '); ?>dt</span></td>
                      <td class="a-center movewishlist"><input maxlength="12" class="input-text qty" title="Qty" size="4" value="<?=$_SESSION['panier'][$produitt['idP']]?>" name=""></td>
                      <td class="a-center hidden-table"><span class="cart-price"> <span class="price"></span> </span><?= number_format ($produitt['tarifPP'],2,',',' '); ?>dt</td>
                      <td class="a-center last"><a class="button remove-item" title="supprimer" href="afficherProduit.php?del=<?= $produitt['idP'];?>"><span><span>Remove item</span></span></a></td>
            ...
            <div class="col-sm-4">
              <div class="totals">
                ...
                <div class="inner">
                  <table class="table shopping-cart-table-total" id="shopping-cart-totals-table">
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <td class="a-right"><strong><span class="price"><?=$panier->total()?>dt</span></strong></td>
                      </tr>
                    </tfoot>
                  ...
                  <ul class="checkout">
                    <li>
                      <a class="button btn-proceed-checkout" title="Proceed to Checkout" type="submit" href="paiement.php"><span>Paiment</span></a>
                    </li>
                    <br>
