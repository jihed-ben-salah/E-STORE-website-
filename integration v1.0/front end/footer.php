        ...
        <div class="row">
          <div class="col-sm-12 col-xs-12 col-lg-8">
            <div class="footer-column pull-left">
              ...
              <ul class="links">
                <li class="first"><a href="#" title="Contact us">Mon Compte</a></li>
                <li><a href="#" title="About us">Historique de commande</a></li>
                <li><a href="#" title="faq">Livraison</a></li>
                <li><a href="#" title="Popular Searches">Paiement</a></li>
                <li class="last"><a href="#" title="Where is my order?">Comment Passer Une Commande</a></li>
            ...
            <div class="footer-column pull-left">
              ...
              <ul class="links">
                ...
                <li><a title="Information" href="#">Service Client</a></li>
                <li><a title="Addresses" href="#">Partenariat</a></li>
            ...
            <div class="footer-column pull-left">
              ...
              <ul class="links">
                <li class="first"><a href="#" title="About us">Vendez Sur E-STORE</a></li>
                <li><a href="#" title="Blog">Devenez un partenaire de E-STORE</a></li>
                <li class="last"><a title="Orders History" href="#">Contacter Nous</a></li>
            </div>
          </div>
