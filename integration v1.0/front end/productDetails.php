              ...
              <form action="#" method="post" id="product_addtocart_form">
                ...
                <div class="product-img-box col-sm-4 col-xs-12">
                  ...
                  <div class="product-image">
                    <div class="large-image"> <a href="products-images/product.jpg" class="cloud-zoom" id="zoom1"> <img src="assets/images/produits/<?PHP echo $produit['imageP']; ?>" alt="product image"> </a> </div>
                ...
                <div class="product-shop col-sm-8 col-xs-12">
                  ...
                  <div class="add-to-box">
                   ...
                   <?php }else{ ?>
                  <a class="button btn-cart " href='formconnexionuser.php'>ajouter au panier</a>
                    <?php }?>                    </div>
