...
$produits= $produitC->afficherProduitByCat($_GET['id_categories']);
$categories = $produitC->afficherCategoriesById($_GET['id_categories']);
$DB = new DB();
  ...
  <?php foreach($categories as $categorie){?>
    <div>
      <aside class="col-right sidebar col-sm-3">
        <div>
        <div class="main-text"> <?=$categorie['nom_categories'];?></div>
        <div class="block-content">
         <img class="main-image" alt="image club affricain" src="assets/images/<?= $categorie['img'];?>">
        </div>
      </div>
    </div>
    </aside>
                    ...
                    <table id="wishlist-table" class="clean-table linearize-table data-table">
                      ...
                      ?>
                        <tr id="item_31" class="first odd">
                          <td class="wishlist-cell0 customer-wishlist-item-image"><a title="Softwear Women's Designer" href="#" class="product-image"><img width="150" height="150" alt="imageP" src="assets/images/produits/<?php echo $produit['imageP'] ?>"></a></td>
