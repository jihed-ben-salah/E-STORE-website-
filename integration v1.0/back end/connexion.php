            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form action="../vew/ajoutF.php" method="POST"  method="POST" class="register-form" id="register-form">
                            <div class="form-group">
                                <label for="lpgin"><i class="zmdi zmdi-account material-icons-name"></i></label>
                            ...
                            <div class="form-group form-button">
                                <a href="../front end/views/dashboard.php" class="form-submit" >connecter</a>
            ...
            <div class="container">
                <div class="signin-content">
                    <div class="signin-image">
                        <figure><img src="assets/colorlib-regform-7/images/signin-image.jpg" alt="sing up image"></figure>
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form" id="login-form">
                            ...
                            <div class="form-group form-button">
                                <a href="../views/pages-forget.php" class="form-submit" >forget password</a>
                            </div>
                        </form>
