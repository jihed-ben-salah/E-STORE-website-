...
<body>
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="stats.php"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    <h3 class="menu-title">UI elements</h3><!-- /.menu-title -->
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>Components</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="ui-buttons.html">Bouttons</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">Badges</a></li>
                            <li><i class="fa fa-bars"></i><a href="ui-tabs.html">tableaux</a></li>
                            <li><i class="fa fa-share-square-o"></i><a href="ui-social-buttons.html">bouttons sociaux</a></li>
                            <li><i class="fa fa-id-card-o"></i><a href="ui-cards.html">cartes</a></li>
                            <li><i class="fa fa-exclamation-triangle"></i><a href="ui-alerts.html">Alarmes</a></li>
                            <li><i class="fa fa-spinner"></i><a href="ui-progressbar.html">Bares de progression</a></li>
                            <li><i class="fa fa-fire"></i><a href="ui-modals.html">les models</a></li>
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="commentaires.php">table de commentaires</a></li>
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Data table : produit</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
			...
			?>
				<tr>
                    <td><image src="assets/images/produits/<?php echo $produit['imageP']; ?>"></td>
					...
					<td>
                    <a type="button" class="btn btn-primary shop-item-button" href = "produitAdmin.php?idP=<?= $produit['idP'] ?>">Supprimer</a>
					</td>
					<td>
				<a href="../views/modifier_produit.php?idP=<?PHP echo $produit['idP']; ?>">Modifier</a>
