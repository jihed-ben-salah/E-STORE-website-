    ...
    <aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="tables-data.php"><img src="assets/images/logo.png" alt="Logo" height=70% width=70%></a>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="tables-data.php"> <i class="menu-icon fa fa-dashboard"></i>Dashboard </a>
                    </li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Vos Produit :</strong>
                            </div>
                            <div class="card-body">
