                                            ...
                                            <form class="needs-validation" action="ajoutP.php" method="POST" novalidate="">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="refP" class="form-control" id="reference" placeholder="reference "  required="">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5 mb-3">
                                                        ...
                                                        <input class="form-control" name="categoriesP" id="categories"  required="">
                                                    </div>
                                                ...
                                                <input type = "file" name = "imageP" ></div>
                                                <hr class="mb-4">
