<?PHP
    ...
    $listescommentaires=$commentairesC->afficherCommentaires();
    if(isset($_POST['id'])){
        $commentairesC->supprimerCommentaires($_POST['id']);
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Tableau de données :commentaires</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Table de commentaires</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <?PHP
				foreach($listescommentaires as $commentaires){
			?>
				<tr>
					<td><?PHP echo $commentaires['id']; ?></td>
                    <td><?PHP echo $commentaires['pseudo']; ?></td>
                    <td><?PHP echo $commentaires['commentaire']; ?></td>
                    <td><?PHP echo $commentaires['id_produit']; ?></td>
					<td>
                 <!--<a type="button" class="btn btn-primary shop-item-button" href = "commentaires.php?id=">Supprimer</a>-->
                  <form action="commentaires.php" method="POST">
                  <input class="btn btn-primary shop-item-button" type="submit" name="supprimer" value="supprimer">
                  <input type="hidden" value="<?php echo $commentaires['id']; ?> "name="id">
                  </form>
					</td>
				</tr>
			<?PHP
