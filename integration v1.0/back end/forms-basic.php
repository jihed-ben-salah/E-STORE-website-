...
if (isset($_GET['id']))
{
  if(!empty($_GET['id']))
  {
    ...
    $reponse=$actualite1C->recupererActualite($_GET['id']);
    $data=$reponse->fetch() ;
...
-->
                                            ...
                                            <div class="col-lg-6">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <strong>PARTENARIAT</strong> EDIT
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form action="modifierPArtenariat.php" method="GET" class="form-horizontal">
                                                                                                                    <div class="form-group"><label for="nf-email" class=" form-control-label">Id</label><input type="Nom"  disabled="disabled" value="<?= $data['id'] ?>" id="nf-email" name="id" placeholder="Enter Nom.." class="form-control"><span class="help-block">Please enter your name</span></div>

                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-email" class=" form-control-label">NOM</label></div>
                                                                <div class="col-12 col-md-9"><input type="nom"  value="" id="nf-email" name="nom"  id="hf-email"  placeholder="Enter Email..." class="form-control"><span class="help-block">Please enter your email</span></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="hf-password" class=" form-control-label">IMAGE</label></div>
                                                                <div class="col-12 col-md-9"><input type="file" id="hf-password"  value=""name="date" placeholder="Enter Password..." class="form-control"><span class="help-block">Please enter your password</span></div>
                                                            </div>
                                                        </form>
                                                    </div>
                                                    <div class="card-footer">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <strong>Actualité</strong> : ADD
                                                    </div>
                                                    <div class="card-body card-block">
                                                        <form action="modifierActualite.php" method="GET" class="">
                                                        <div class="form-group"><label for="nf-email" class=" form-control-label">Id</label><input type="Nom"  disabled="disabled" value="<?= $data['id'] ?>" id="nf-email" name="id" placeholder="Enter Nom.." class="form-control"><span class="help-block">Please enter your name</span></div>
    
                                                        <div class="form-group"><label for="nf-email" class=" form-control-label">Nom</label><input type="Nom" value="<?= $data['nom'] ?>" id="nf-email" name="nom" placeholder="Enter Nom.." class="form-control"><span class="help-block">Please enter your name</span></div>
                                                            <div class="form-group"><label for="nf-password" class=" form-control-label">Date</label><input type="date" id="nf-password" value="<?= $data['date'] ?>"name="date" placeholder="Enter Password.." class="form-control"><span class="help-block">Please enter your date</span></div>
