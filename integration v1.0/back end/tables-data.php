<?PHP
    ...
    $listeproduit=$produitC->afficherProduitfournisseur();
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children active dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="tables-data.php?id=<?php echo $categorie['id']; ?>">Data Table</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children active dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>ajouter produit </a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="../views/formulaire.php">formulaire</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="deconnexion.php">Logout</a></li>
        ...
        <div class="content mt-3">
			...
			?>
				<tr>
                    ...
                    <td><image src='assets/images/produits/<?=$produit['imgP'];?>'></td>				
	<td>
					...
					<td>
				<a href="../views/modifier-produit.php?idP=<?PHP echo $produit['idP']; ?>">Modifier</a>
