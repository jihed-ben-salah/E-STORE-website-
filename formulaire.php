...
//On teste si le formulaire a été soumis
	if ((isset($_POST['ville'])) && (isset($_POST['rue']))	&& (isset($_POST['email_addr'])) && (isset($_POST['choix'])) && (isset($_POST['numero_de_carte ']) ))
	{
	//on teste si tous les champs du formulaire sont remplits
	if ((!empty($_POST['ville'])) && (!empty($_POST['rue']))	&& (!empty($_POST['email_addr'])) && (!empty($_POST['choix'])) && (!empty($_POST['numero_de_carte '])))
	{
...
$sql=" INSERT INTO `commande` (`id_commande`, `id_client`, `montant`, `adr`, `tel`, `ville`, `rue`, `methodep`, `ncarte`, `codecarte`, `nomcarte`, `Date_cmd`, `etat`, `idP`) `dateInscrit`)
VALUES('','$_POST[ville]','$_POST[rue]','$_POST[email_addr]','$_POST[choix]','$_POST[numero_de_carte]','$date_inscri')";
...
<div><label for="Cb">Carte bancaire</label><input type="radio" id="cb" name="choix" value="cb" onclick="afficher('visible');" checked="checked"></div>
